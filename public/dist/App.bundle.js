...
exports.default = function (input, lat, lng) {
  if (!input) return;
...
var loadPlaces = function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (_ref) {
    var data = _ref.data;
...
function ajaxHeart(e) {
  ...
  e.preventDefault();
  console.log(this);
  _axios2.default.post(this.action).then(function (_ref) {
    var data = _ref.data;
